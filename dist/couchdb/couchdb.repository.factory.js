...
exports.CouchDbRepositoryFactory = void 0;
...
class CouchDbRepositoryFactory {
    ...
    async create(entity) {
        ...
        return new ((0, couchdb_repository_mixin_1.CouchDbRepositoryMixin)(driver, entity))();
    }
    getDbName(entity) {
        const dbName = (0, couchdb_utils_1.getEntityMetadata)(entity);
        if (!dbName) {
